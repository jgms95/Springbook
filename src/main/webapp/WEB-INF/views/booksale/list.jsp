...
<br><br>
		...
		<form class="form-inline " name='sform' action="#" method="post" >
				<aside>
					<select class="btn btn-outline-secondary">
						<option>장르선택</option>
                                ...
                                <option>수필</option>
                                <option>에세이</option>
					</select> <input class="form-control mr-sm-2" placeholder="search" type="text" name='search'>
            ...
            <div class="product-grid">
                <div class="product-image">
                    ...
                    <ul class="social">
                        ...
                        <li><a href="" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                   		<li><a href="/booksale/delete/${dto.ino }" data-tip="remove"><i class="glyphicon glyphicon-remove" style="color:red;" ></i></a></li>
                    </ul>
                ...
                <div class="product-content">
                    <h1 class="title"><a href="#">${dto.ititle }</a></h1>
                      <h1 class="title"><a href="#"> 지은이: ${dto.publisher }</a></h1>
                   
                   <c:if test="${dto.percent!=0 }">
                    <div class="price">${dto.price*(100-dto.percent)/100}원
