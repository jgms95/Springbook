...
<body>
	...
	<div class="container" style="margin: 30px 0 30px 0;">
		...
		<div class="form-group was-validated">
			...
			<label for="rrNum1">주민등록번호 :</label> <input type="text" maxlength="6" class="form-control" id="rrNum1" placeholder="앞자리수를 입력하세요" name="rrNum1" required>
			&nbsp;-&nbsp;<input type="text" maxlength="7" class="form-control" id="rrNum2" placeholder="뒷자리수를 입력하세요" name="rrNum2"	required>
			<br>
